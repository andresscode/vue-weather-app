...
describe('api', () => {
  const adjustTimezone = (dt: number) => mapApiTimestamp(dt - 10800)

  it('retrieves hourly forecast correctly', async () => {
    // The 'id' is a randomUUID so ignore it
    const expected: HourForecastModel[] = [
      { id: '1', temperature: 22, pop: 0, iconCode: '04n', time: adjustTimezone(1725688800) },
      { id: '2', temperature: 21, pop: 0, iconCode: '03d', time: adjustTimezone(1725699600) },
      { id: '3', temperature: 25, pop: 0, iconCode: '01d', time: adjustTimezone(1725710400) },
      { id: '4', temperature: 27, pop: 0, iconCode: '01d', time: adjustTimezone(1725721200) },
      { id: '5', temperature: 26, pop: 0, iconCode: '01d', time: adjustTimezone(1725732000) },
      { id: '6', temperature: 24, pop: 0, iconCode: '01n', time: adjustTimezone(1725742800) },
      { id: '7', temperature: 24, pop: 0, iconCode: '01n', time: adjustTimezone(1725753600) },
